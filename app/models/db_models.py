...
class Prediction(Base):
    ...
    prediction_label = Column(String(120), nullable=True)
    explanation = Column(Text, nullable=True)
    features_json = Column(Text, nullable=True)
    supporting_snapshot_ids_json = Column(Text, nullable=True)
...
class AgentRun(Base):
    ...
    run_type = Column(String(80), nullable=True)
    status = Column(String(40), nullable=False)
    cities_requested = Column(Integer, nullable=False, default=0)
    ...
    weather_snapshots_created = Column(Integer, nullable=False, default=0)
    market_snapshots_created = Column(Integer, nullable=False, default=0)
